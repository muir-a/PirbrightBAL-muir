...
options("warn"=-1)
venndir(PH1N1_Set, poly_alpha=0.5, proportional=TRUE, set_colors = set_colours, label_preset="main items", show_items = c("sign item"), font_cex = c(3,2,1), item_cex = c(2,2), overlap_type="each")
dev.off()
...
options("warn"=-1)
venndir(HANP_Set, poly_alpha=0.5, proportional=TRUE, set_colors = c('#FF999A', '#A6CEE3'), label_preset="main items", show_items = c("sign item"), font_cex = c(3,2,1), item_cex = 4, overlap_type="each")
dev.off()
...
options("warn"=-1)
venndir(IL1b_Set, poly_alpha=0.5, proportional=TRUE, set_colors = set_colours, label_preset="main items", show_items = c("sign item"), font_cex = c(3,2,1), item_cex = 2.5, overlap_type="each")
dev.off()
