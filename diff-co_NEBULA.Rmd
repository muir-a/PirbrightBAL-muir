...
Following on from 'differential_all'. This script delineates patterns of differential gene expression between our experimental conditions and gene co-expression using the nebula package. 
...
options("warn"=-1)
venndir(PH1N1_Set, poly_alpha=0.5, proportional=F, set_colors = set_colours, font_cex = c(2.8,3,3), overlap_type="each")
dev.off()
...
options("warn"=-1)
venndir(HANP_Set, poly_alpha=0.5, proportional=F, set_colors = set_colours, font_cex = c(2.8,3,3), overlap_type="each")
dev.off()
...
options("warn"=-1)
venndir(IL1b_Set, poly_alpha=0.5, proportional=F, set_colors = set_colours, font_cex = c(2.8,3,3), overlap_type="each")
dev.off()
...
options("warn"=-1)
venndir(IFI6_Set, poly_alpha=0.5, proportional=F, set_colors = set_colours, font_cex = c(2.8,3,3), overlap_type="each")
dev.off()
