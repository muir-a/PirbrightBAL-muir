...
Following on from 'differential_all'. This script delineates patterns of gene co-expression between our experimental conditions (differential co-expression). 
...
# create colour list of lists, red for up, blue for down , purple for mix
Colour_list <- 
}
```
