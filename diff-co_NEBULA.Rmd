...
Following on from 'differential_all'. This script delineates patterns of gene co-expression between our experimental conditions (differential co-expression) using the nebula package. 
