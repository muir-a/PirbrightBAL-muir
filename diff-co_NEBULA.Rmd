...
options("warn"=-1)
venndir(PH1N1_Set, main="pH1N1", poly_alpha=0.5, proportional=FALSE, set_colors = set_colours, label_preset="main items", show_items = c("sign item"), font_cex = c(3,2,1), item_cex = 2.5, overlap_type="each",)
dev.off()
...
options("warn"=-1)
venndir(HANP_Set, main="Ad-HA/NP", poly_alpha=0.5, proportional=FALSE, set_colors = set_colours, label_preset="main items", show_items = c("sign item"), font_cex = c(3,2,1), item_cex = 2.5, overlap_type="each",)
dev.off()
...
options("warn"=-1)
venndir(IL1b_Set, main="Ad-HA/NP Ad-IL1b", poly_alpha=0.5, proportional=FALSE, set_colors = set_colours, label_preset="main items", show_items = c("sign item"), font_cex = c(3,2,1), item_cex = 2.5, overlap_type="each",)
dev.off()

png(filename='Results/Venn_IFI6.png', height=1080, width=2160)
IFI6_Set = list(Macrophages=Create_Set(IFI6_Macrophages_Data), B_Cells=Create_Set(IFI6_BCells_Data))
options("warn"=-1)
venndir(IFI6_Set, poly_alpha=0.5, proportional=FALSE, set_colors = set_colours, label_preset="main items", show_items = c("item"), font_cex = c(2,2,1), item_cex = 2.5, overlap_type="each",)
dev.off()
...
GO_HANP <- GO_HANP[GO_HANP$Significant > 4,]
...
GO_IFI6 <- GO_IFI6[GO_IFI6$Significant > 4,]
