...
heatmap.2(heat_all_Matrix, margins=c(30,20), scale="row", col = bluered(100), cexRow=2, cexCol=2,  trace="none", key=TRUE, lhei=c(1,10), lwid=c(1,10)) 
dev.off()
...
B_Cell_genes <- c("ANGPTL1", "SCAP", "ENSSSCG00000033183", "ZBTB32", "BLK", "SNX3", "SMC6", "LTB", "MS4A1", "ENSSSCG00000033721", "RPS3A", "RPS26", "RPS11", "RPL37", "COX17", "ENSSSCG00000001075", "CTSC", "SPCS3", "ENSSSCG00000039071", "SNRPD1", "DUT", "HMGB2", "ENSSSCG00000009327", "ITM28", "ANXA1", "TYROB")
...
#B_Cells_Matrix <- B_Cells_Matrix[rowSums(B_Cells_Matrix) > 2, ]

png(filename='Results/B_Cells_Cross_Heatmap.png', height=1080, width=2160)
heatmap(B_Cells_Matrix, margins=c(15,5), Colv=NA, scale="none", keep.dendro = FALSE)
dev.off()
...
CD8NK_genes <- c("PDK1", "NCR1", "PLD4", "EVL", "TCF7", "LCK", "RDX", "ENSSSCG00000029596", "S100A1", "CD8A", "CXCR1", "ENSSSCG00000000640", "ENSSSCG00000023584", "KLRB1", "CD74", "S100A6", "CD3E", "ITM2B", "ANXA1", "TYROBP", "TBXAS1")
...
#CD8NK_Matrix <- CD8NK_Matrix[rowSums(CD8NK_Matrix) > 3, ]

png(filename='Results/CD8NK_Cross_Heatmap.png', height=1080, width=2160)
heatmap(CD8NK_Matrix, margins=c(20,5), Colv=NA, scale="none", keep.dendro = FALSE)
dev.off()
...
mitotic_genes <- c("CENPF", "TK1", "LMNB1", "BIRC5", "CENPE", "UHRF1", "UBE2C", "COX17", "ENSSSCG00000001075", "CTSC", "SPCS3", "ENSSSCG00000039071", "SNRPD1", "DUT", "HMGB2", "ENSSSCG00000009327", "LCK", "RDX", "ENSSSCG00000029596", "ACTG1", "S100A6", "CD3E", "ENSSSCG00000033721", "ENSSSCG00000014565")
...
#mitotic_matrix <- mitotic_matrix[rowSums(mitotic_matrix) > 2, ]

png(filename='Results/mitotic_T_cells_Cross_Heatmap.png', height=1080, width=2160)
heatmap(mitotic_matrix, margins=c(20,5), Colv=NA, scale="none", keep.dendro = FALSE)
dev.off()
...
T_cell_genes <- c("S100A6", "CD3E", "ENSSSCG00000033721", "ENSSSCG00000014565", "CENPF", "TK1", "LMNB1", "BIRC5", "CENPE", "UHRF1", "UBE2C", "IL6R", "CGA", "CD226", "PDK1", "LCK", "RDX", "ENSSSCG00000029596", "S100A1", "CD8A", "CXCR1", "ENSSSCG00000000640", "ENSSSCG00000023584", "KLRB1", "CD5")
...
#T_Cell_Matrix <- T_Cell_Matrix[rowSums(T_Cell_Matrix) > 2,]

png(filename='Results/conventional_T_cells_Cross_Heatmap.png', height=1080, width=2160)
heatmap(T_Cell_Matrix, margins=c(20,5), Colv=NA, scale="none", keep.dendro = FALSE)
dev.off()
...
plot0 <- ggplot(data=df_legend_colours, aes(x=dummy_data)) +
  geom_point(aes(y=dummy_data, color=Cell_Type[1]), size=10) +
