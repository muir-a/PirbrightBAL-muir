...
```{r split-batches}
#BAL
BAL_Union_sce_run1 <- BAL_Union_sce[BAL_Union_sce$run == 1]
BAL_Union_sce_run2 <- BAL_Union_sce[BAL_Union_sce$run == 2]
BAL_Union_sce_run3 <- BAL_Union_sce[BAL_Union_sce$run == 3]
BAL_Union_sce_run4 <- BAL_Union_sce[BAL_Union_sce$run == 4]
BAL_Union_sce_run5 <- BAL_Union_sce[BAL_Union_sce$run == 5]
BAL_Union_sce_run6 <- BAL_Union_sce[BAL_Union_sce$run == 6]
