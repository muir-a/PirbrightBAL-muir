...
p1 <- plotUMAP(sce_all_filt, colour_by="cluster", by_exprs_values='reconstructed', point_size=0.3, text_size=18) + guides(colour = guide_legend(override.aes = list(size=5)))
p2 <- plotUMAP(sce_all_filt, colour_by="named_cluster", by_exprs_values='reconstructed', point_size=0.3, text_size=18) + guides(colour = guide_legend(override.aes = list(size=5)))
