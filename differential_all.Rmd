...
legend_colours <- legend_colours[c("Macrophages, 1, 4, 8", "Monocytes, 15", "cDCs, 13", "Plasma Cells, 2, 3", "B Cells, 12, 16", "CD4 T Cells, 7, 20a", "Tregs, 10", "Mitotic CD4 T Cells, 18b", "Mitotic CD8 T Cells, 18a", "CD8 T Cells, 6, 9a, 20b", "NK cells, 9b, 9c", "T-cell-like, 14", "Unknown, 21")]
...
plot1 <- plotUMAP(sce_all_filt, point_size=0, text_by="main_clusters", text_size=14) +
